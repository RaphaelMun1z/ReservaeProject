            ...
            <main class="matchpass-main">
                ...
                <section class="matchpass-card">
                    ...
                    <#if messagesPerField.existsError("username", "password")>
                        <div class="matchpass-alert" role="alert"
                    ...
                    <form id="kc-form-login" class="matchpass-form" action="${url.loginAction}" method="post">
                        ...
                        <div class="matchpass-field">
                            ...
                            <div class="matchpass-input-container">
                                ...
                                <input id="password" name="password" type="password" placeholder="••••••••"
                                       ...
                                       aria-invalid="<#if messagesPerField.existsError('username', 'password')>true<#else>false</#if>">
                                <button class="matchpass-password-toggle" type="button" data-password-toggle
                                        aria-label="Mostrar senha" aria-controls="password">
                                    <svg class="matchpass-eye-icon" data-eye-visible viewBox="0 0 24 24"
                                         aria-hidden="true">
                                    ...
                                    <svg class="matchpass-eye-icon is-hidden" data-eye-hidden viewBox="0 0 24 24"
                                         aria-hidden="true">
                        ...
                        <div class="matchpass-options">
                            ...
                            <#if realm.resetPasswordAllowed>
                                <a href="${url.loginResetCredentialsUrl}" class="matchpass-link matchpass-forgot">Esqueceu
                                    a senha?</a>
                            </#if>
                        </div>
                        <button id="kc-login" name="login" type="submit" class="matchpass-submit">Entrar na Conta
                        </button>
                    </form>
